...
const PayPalButton = ({ setError }) => {
  const CLIENT_ID =
    "ARUbZz_LME67zEzKC1wBux6vbb2ItFEAQ5ktlP33XwL-3-RJUAhgzhQF9rWXayibESx2XUIVm5fbDf_E";
  // const CLIENT_ID =
  //   "AUDsgef5K98aZZ6zTO3sbC7HH3pyHSCuN_06MBxea0GDrS5NtJnFGNcrkxsnQ9SVFOiCVfGoIP-QvAzP";
